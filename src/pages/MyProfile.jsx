...
const MyProfile = () => {
  ...
  const updateUserProfileData = async () => {
    try {
      ...
      formData.append("address_line1", userData.address_line1);
      formData.append("address_line2", userData.address_line2);
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-[#363636]">
          ...
          {isEdit ? (
            ...
            <p className="text-gray-500">
              {userData.address_line1} <br /> {userData.address_line2}
            </p>
          )}
        </div>
      </div>
